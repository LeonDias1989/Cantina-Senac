...
public class TelaLogon extends JFrame {
	...
	private void iniciarComponentes() {
		...
		buttonFuncionario.addActionListener(new LogonFuncionario());
		...
		buttonCliente.addActionListener(new LogonCliente());
		...
		buttonCriarNovoCliente.addActionListener(new CadastroCliente());
