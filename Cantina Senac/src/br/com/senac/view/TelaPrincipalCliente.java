...
public class TelaPrincipalCliente extends JFrame implements ActionListener {
	...
	public TelaPrincipalCliente(String matricula) {
	...
	private void iniciarPanelCompras() {
		...
		buttonCreditarSaldo.addActionListener(this);
		...
		buttonSaldoTotal.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == buttonCreditarSaldo){
			
			new TelaCreditarSaldo();
			
			ClienteDAODB clienteDataBase = new ClienteDAODB();
			Cliente cliente = clienteDataBase.getCliente(matricula);
			
			textFieldSaldo.setText(""+cliente.getSaldo());
